    ...
    <View>
      ...
      {resultAvaible == false ? (
        <SearchCard
          ...
          uName={'Sebnem Katırcıoglu'}
          uSName={'sbnm'}
          pPhoto={
            'https://images.unsplash.com/photo-1691175085195-a743156f9b2c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxNDN8fHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60'
          }
        />
      ) : (
        <SearchCard
